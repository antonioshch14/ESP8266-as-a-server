void append_page_header() {
	...
	webpage += F("h2{color:orange;font-size:0.6em;}");
	webpage += F("h3{margin: 0.1em; font-size:0.6em;}");
	webpage += F("h4{margin: 0.1em;font-size:0.6em;}");
	webpage += F("h5{margin: 0.1em;font-size:0.6em;}");
	webpage += F("h6{margin: 0.1em;font-size:0.8em;}");
...
void append_page_footer() { // Saves repeating many lines of code for HTML page footers
	...
	/*+String(char(byte(0x40 >> 1))) + String(char(byte(0x88 >> 1))) + String(char(byte(0x5c >> 1))) + String(char(byte(0x98 >> 1))) + String(char(byte(0x5c >> 1)));
	...
	*/
	webpage += F("2020 Belov");
	webpage += F("<footer>&copy;"); "</footer>";
